...
def main():
	...
	metrics_list = []
	### Start dataset loop here
	AVAILABLE_DATASETS = ["DoS", "Fuzzy", "gear", "RPM"]
	for dataset_prefix in AVAILABLE_DATASETS:
		DATASET_FILEPATH = consts.ROOT_PATH + DATA_FOLDER + dataset_prefix + DATASET_POSTFIX
		...
		for proportion in train_data_proportions:
			...
			### End experiment loop here

	##### Finish dataset loop here
	...
	print(metrics_df)
	metrics_df.to_csv("all_dataset_var_metrics_dataframe.csv")
